...
* `format_trade_request(action, coin_id, symbol, quantity, entry_price, target_exit_price, stop_loss_price, order_type, currency, rationale)`: Constructs a properly formatted `TradeRequest` JSON object for policy validation and execution.
